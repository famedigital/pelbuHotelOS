  ...
  return (
    <>
      <div className="relative bg-espresso">
        <SiteHeader />
        <div className="mx-auto max-w-[1200px] px-6 pb-14 pt-28 md:px-8 md:pt-32">
          <p className="text-xs tracking-[0.3em] text-gold uppercase">{eyebrow}</p>
          <h1 className="mt-3 max-w-2xl text-4xl text-white md:text-5xl">{title}</h1>
          ...
          <p className="mt-6 text-sm text-white/55">
            ...
            {" · "}
            <Link href="/agents" className="text-gold underline-offset-4 hover:underline">
              Agent booking
            </Link>
          </p>
        </div>
      ...
      <main className="mx-auto grid max-w-[1200px] gap-10 px-6 py-12 md:grid-cols-[minmax(0,1fr)_320px] md:px-8 md:py-16">
        <div>{children}</div>
