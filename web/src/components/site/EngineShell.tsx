  ...
  return (
    <>
      ...
      <main className="min-h-[70dvh] bg-background">
        <header className="border-b border-border bg-sky-100/40">
          <div className="mx-auto flex max-w-[1200px] flex-col gap-5 px-5 pb-8 pt-8 md:flex-row md:items-end md:justify-between md:px-8 md:pb-10 md:pt-10">
