  ...
  "inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        citrus: "border-transparent bg-ember-tint text-ember-deep",
        mint: "border-transparent bg-[#d8e8e0] text-juniper",
        sky: "border-transparent bg-mist-1 text-juniper",
        juniper: "border-transparent bg-mist-1 text-juniper",
        ember: "border-transparent bg-ember-tint text-ember-deep",
      },
    },
    defaultVariants: {
      variant: "default",
