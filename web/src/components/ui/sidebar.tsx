...
/**
 * shadcn sidebar contract (standard):
 * - Collapse/expand only via SidebarTrigger / rail / Ctrl+B — not hover.
 * - Icon mode stays icon-width; labels and nested menus stay hidden.
 * - Tooltips appear on collapsed menu buttons (no layout shift).
 */
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Gap placeholder — width tracks expanded/icon; never hover-grows. */}
      <div
        className={cn(
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground [&>svg]:text-sidebar-accent-foreground flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg:last-child]:shrink-0 [&>svg]:size-4",
