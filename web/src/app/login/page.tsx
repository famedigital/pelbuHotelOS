...
export const metadata: Metadata = {
  title: "Work login | Pelbu Suites",
  description: "Secure access for Pelbu Suites staff, desk teams and partners.",
...
const WORKSPACES = [
  ...
  },
  {
    ...
    description: "Sign in with your agent code to book and track credit.",
    href: "/agents/login",
    icon: BriefcaseBusinessIcon,
  },
] as const;

export default async function WorkLoginPage() {
    ...
    <main className="min-h-dvh bg-background px-4 py-10 text-foreground sm:px-6 sm:py-16">
      <div className="mx-auto w-full max-w-lg">
        ...
        <p className="mt-3 leading-6 text-muted-foreground">
          One secure entry point for hotel operations. Your account determines
          what you can open after sign-in.
        </p>
        ...
        <p className="mt-7 text-xs leading-5 text-muted-foreground">
          Access is private. Agent accounts only show their own company,
          bookings and credit information.
        </p>
      </div>
    </main>
  );
