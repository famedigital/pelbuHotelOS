  ...
  return (
    <div className="pt-24">
      <div className="mx-auto max-w-3xl px-6 py-12 md:px-10">
        <h1 className="font-display text-4xl">Chains & brands</h1>
        <p className="mt-4 text-lg text-[var(--muted)]">
          Shared standards across properties with room to grow. Chain package
          starts from a clear floor price — custom quote for larger groups.
        </p>
