...
export function hotelJsonLd({
  ...
  return compact({
    ...
    alternateName: [
      "Pelbu Suites Olakha",
      "Pelbu Suites Thimphu",
      "Hotel in Olakha Thimphu",
    ],
    description: SITE_DESCRIPTION,
    slogan: "Stay · dine · recover in Olakha, Thimphu",
    knowsAbout: [
      "Hotels in Thimphu",
      "Place to stay in Thimphu",
      "Hotel in Olakha",
      "Bhutanese restaurant Thimphu",
      "Hotel spa Thimphu",
      "Travel agent accommodation Bhutan",
    ],
    url: absoluteUrl("/"),
