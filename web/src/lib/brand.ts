...
export const BRAND_ICONS = {
  ...
  /** Primary SVG mark — light backgrounds / general chrome. */
  mark: iconPath("/icons/innora-mark.svg"),
  /** SVG mark for dark chrome. */
  markLight: iconPath("/icons/innora-mark-light.svg"),
