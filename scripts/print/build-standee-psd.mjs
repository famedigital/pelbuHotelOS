...
async function main() {
  ...
  await exportStandee(page, {
    ...
    layers: [
      ...
      { name: "08_seg_01_burger", sel: ".radial .seg:nth-child(1)" },
      { name: "08_seg_02_latte", sel: ".radial .seg:nth-child(2)" },
      { name: "08_seg_03_chai", sel: ".radial .seg:nth-child(3)" },
      { name: "08_seg_04_boba", sel: ".radial .seg:nth-child(4)" },
      { name: "08_seg_05_croissant", sel: ".radial .seg:nth-child(5)" },
